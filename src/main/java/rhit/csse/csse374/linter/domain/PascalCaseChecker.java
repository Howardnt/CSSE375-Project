...
/**
 * Cursory check: ensure method names are PascalCase.
 *
 * Rules (heuristic):
 * - Ignore constructors / static initializers (<init>, <clinit>)
 * - Ignore synthetic/bridge methods
 * - Flag names containing underscores or starting with a non-uppercase letter
 * - Allow only letters/digits after the first character
 */
public class PascalCaseChecker extends Cursory {

    @Override
    public String name() {
        return "PascalCaseMethodNames";
    }
    ...
    private Violation checkMethodName(ASMMethod method) {
        ...
        String msg = "NonPascalCaseMethodName (name=\"" + methodName + "\")";
